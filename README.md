...
- [cafeTechne/antigravity-link-extension](https://github.com/cafeTechne/antigravity-link-extension) 📇 🏠 🍎 🪟 🐧 - MCP server and mobile companion for Google's Antigravity IDE. Mirror active AI chat sessions on your phone, send messages, upload files, stop AI generation, and automate devops workflows via 9 MCP tools or a local OpenAPI HTTP API. Listed in the official MCP Registry.
