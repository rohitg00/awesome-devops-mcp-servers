...
- [jagmarques/asqav-mcp](https://github.com/jagmarques/asqav-mcp) 🐍 🏠 ☁️ - Quantum-safe AI agent governance MCP server. ML-DSA-65 (FIPS 204) signed, tamper-evident audit trails with policy enforcement, threat detection (PII, injection, secrets), multi-party signing, and compliance evidence (EU AI Act Art. 12). Install via `pip install asqav`.
