...
- [kubestellar/console](https://github.com/kubestellar/console) 🏎️ ☁️/🏠 - Multi-cluster Kubernetes dashboard with built-in MCP bridge that enables AI assistants to manage and observe workloads across edge and cloud clusters. Features real-time observability, CNCF project integrations (Argo, Kyverno, Istio), and AI-powered operations via Claude, OpenAI, and Gemini providers.
