...
- [shadoprizm/cyberlens-mcp-server](https://github.com/shadoprizm/cyberlens-mcp-server) ☕ 🏠 🐧 🍎 🪟 - Security scanning MCP server for AI assistants. Scan websites (15+ checks locally, 70+ cloud), GitHub repos (secrets, CVEs, code patterns), and Claw Hub skills (malicious code detection). Install via `npx -y @shadoprizm/cyberlens-mcp-server`.
