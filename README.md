...
- [claw-army/claude-node](https://github.com/claw-army/claude-node) 🐍 - Python subprocess bridge for Claude Code CLI. Gives Python code direct access to Claude Code native capabilities via stream-json.
