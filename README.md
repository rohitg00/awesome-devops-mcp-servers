...
- [shibley/apistatuscheck](https://github.com/shibley/apistatuscheck) 📇 ☁️ - MCP server for API Status Check, enabling AI assistants to monitor API and service status pages, check real-time uptime data, and track outage history across 1,100+ services.
