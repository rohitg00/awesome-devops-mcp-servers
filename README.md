...
- [sidclawhq/platform](https://github.com/sidclawhq/platform) 📇 🏠 - Governance proxy for MCP servers — wraps any upstream server with policy evaluation, human approval, and hash-chain audit trails.
