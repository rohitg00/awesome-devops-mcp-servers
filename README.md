...
- [Acacian/aegis](https://github.com/Acacian/aegis) 🐍 🏠 - Policy-based governance middleware for AI agents with native MCP adapter. YAML-driven risk evaluation (<1ms), approval gates, and audit logging for MCP tool calls. Install via `pip install agent-aegis`.
