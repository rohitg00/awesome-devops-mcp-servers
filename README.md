...
- [entire-vc/evc-spark-mcp](https://github.com/entire-vc/evc-spark-mcp) 📇 ☁️ - MCP server for Spark marketplace — search and install 4,500+ curated AI assets (agents, skills, prompts, MCP connectors) with 5 tools and 2 resources.
