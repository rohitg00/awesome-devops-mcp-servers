...
- [eidetic-works/nucleus-mcp](https://github.com/eidetic-works/nucleus-mcp) 🐍 🏠 - 114 MCP tools for persistent memory, execution verification, governance, and compliance. Includes EU DORA, MAS TRM, SOC2 compliance configs. Local-first.
