...
- [Acacian/aegis](https://github.com/Acacian/aegis) 🐍 🏠 ☁️ - MCP security proxy and governance server. Intercepts tool calls, enforces policies, detects rug-pull attacks via SHA-256 tool description pinning, and provides audit trails. Includes MCP server exposing policy evaluation and audit log querying as MCP tools.
