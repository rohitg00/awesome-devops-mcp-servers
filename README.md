...
- [Acacian/aegis](https://github.com/Acacian/aegis) 🐍 🏠 - Policy-based governance middleware for AI agents with native MCP adapter. YAML-driven policy evaluation (sub-millisecond in benchmarked hot paths), approval gates, and audit logging for MCP tool calls. Install via `pip install agent-aegis`.
