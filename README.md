...
- [ddjidd564/env-security-scanner](https://github.com/ddjidd564/env-security-scanner) 📇 🏠 🍎 🪟 🐧 - Environment security auditing MCP server. Scans projects for exposed credentials, wallet vulnerabilities, and misconfigurations. Part of the DeFi Security Alliance toolchain. `npx env-security-scanner`.
