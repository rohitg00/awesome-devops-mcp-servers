...
- [OzorOwn/defi-mcp](https://github.com/OzorOwn/defi-mcp) 📇 ☁️ - MCP server for DeFi & crypto — real-time token prices, wallet balances, gas prices, and DEX swap quotes across 7 chains.
